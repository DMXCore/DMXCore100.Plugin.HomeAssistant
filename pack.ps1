...
$output = Join-Path $root 'artifacts/home-assistant-plugin.dmxplugin'

dotnet publish (Join-Path $root 'src/DMXCore100.HomeAssistantPlugin') --configuration Release --output $publishDir
